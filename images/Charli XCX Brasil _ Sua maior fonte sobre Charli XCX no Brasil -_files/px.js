(function() {
    ...
    var _hn_ver = 5,
        ...
        _kwQuery = window.captify_kw_query_12158 ? '&kw=' + encodeURIComponent(captify_kw_query_12158) : '',
    ...
    (new Image()).src = _dcUrl + 'google_nid=' + _nid + '&google_cm&' + _groupParams;
  	...
  	// Avocet ID sync
  	(new Image()).src = _anxUrl + encodeURIComponent('https://ads.avocet.io/sync?invsrc=5575b5a3d6e9d6ab4a43bc78&adnxs_uid=$UID');
